...
def parse_args_cond_fmri():
    """
    Parse arguments for conditional models
    Returns: conditional fmri generation args namespace
    ...
    parser.add_argument('--gen_folderpath', type=str,help='ori and gen data save path')
    ...
    parser.add_argument('--seq_len', type=int,
                        help='input sequence length,'
                             ' only needed if using short-term datasets(stocks,sine,energy,mujoco)')
    parser.add_argument('--outfold_num', type=int, help='outerfold number')
    parser.add_argument('--infold_num', type=int, help='innerfold number')

    # --- image transformations ---:
    parser.add_argument('--use_stft', type=bool,
                        help='use stft transform')  # can be base
    parser.add_argument('--n_fft', type=int, help='n_fft, only needed if using stft')
    parser.add_argument('--hop_length', type=int, help='hop_length, only needed if using stft')
    parser.add_argument('--delay', type=int,
                        help='delay for the delay embedding transformation, only needed if using delay embedding')
    ...
    # --- conditional model ---:
    parser.add_argument('--num_classes', type=int, help='dataset number of classes')
